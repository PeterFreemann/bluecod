...
export default function Categories() {
  ...
  return (
    <section className="px-4 md:px-12 py-8 relative">
      <div className="bg-[#F0E4FF] md:px-7 px-3 py-5 mb-18">
        <h1 className="text-left  md:text-[24px] font-bold text-[14px]">LISTEN BY ABR CATEGORIES</h1>
      </div>
      <div className="text-left mb-10">
        <h1 className="text-[24px] font-bold">News & Storytelling</h1>
      </div>
